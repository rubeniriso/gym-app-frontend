...
const TrainingDayFormContent = ({ submitFunction, submit_id }: any) => {
  ...
  return (
    <>
      <h1 className="text-center font-bold text-md">Create training day</h1>
      <Form {...form}>
...
export default TrainingDayFormContent;
