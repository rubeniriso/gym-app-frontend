...
const UpdateWeekForm = ({ submitFunction, submit_id }: any) => {
  ...
  return (
    <>
      <h1 className="text-center font-bold text-md">Update week</h1>
      <Form {...form}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Enter new week name" {...field} />
                </FormControl>
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Enter new week description" {...field} />
                </FormControl>
              </FormItem>
            )}
          />
